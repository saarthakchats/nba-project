...
try:
    ...
    # Try to import scoreboard - it might not be available in all versions
    try:
        from nba_api.stats.endpoints import scoreboard
    except ImportError:
        scoreboard = None
    
    # Try to import live scoreboard
    try:
    ...
    def get_today_games(self):
        ...
        try:
            if scoreboard is None:
                print("Scoreboard endpoint not available in this NBA API version")
                return pd.DataFrame()
    ...
    def get_live_scores(self):
        ...
        try:
            if live_scoreboard is None:
                print("Live scoreboard not available in this NBA API version")
                return pd.DataFrame()
